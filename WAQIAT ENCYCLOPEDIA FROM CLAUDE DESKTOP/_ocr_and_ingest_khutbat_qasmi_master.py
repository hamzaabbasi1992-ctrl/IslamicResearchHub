...
OCR_BASE_DIR = r"F:\کتب\ocr text books\خطبات قاسمی"
...
# Volumes Map: vol_num -> (BookID, StartPDFPage, EndPDFPage, VolumeTitle)
VOLUMES_MAP = {
...
# STRICT NARRATIVE STORY PATTERNS (PURE STORIES ONLY)
...
# Disqualification patterns for non-story quotes / rhetoric / sayings
DISQUALIFY_PATTERNS = [
    r'^ارشاد فرمایا',
    r'^فرمایا کہ',
    r'^بیان فرمایا',
...
def get_volume_for_pdf_page(pdf_page):
    ...
    return 1, 3534, pdf_page, "خطبات قاسمی جلد 1"
...
def main():
    ...
    parser.add_argument("--end", type=int, default=2195, help="End PDF page")
    parser.add_argument("--workers", type=int, default=10, help="Concurrent workers")
    args = parser.parse_args()

    print("=" * 85)
    print(f" GOOGLE VISION OCR & INGESTION PIPELINE: KHUTBAT QASMI (VOLUMES 1-6)")
    ...
    print("=" * 85)
    print(f" 🏆 TOTAL PURE WAQIAT INGESTED FOR KHUTBAT QASMI: +{total_waqiat_extracted} WAQIAT!")
    print("=" * 85)
